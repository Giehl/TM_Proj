    ...
    def onOpenFile(self, event):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            for path in paths:
                ...
                lon_mc_ltm=round(sh.iloc[0].geometry.centroid.x)
                ...
                if pr=='AUTO':
                        ...
                        deformm=np.array([deformacao(lat_cen,dlon_ltm)*0.999995,deformacao(lat_cen,dlon_rtm)*0.999995,deformacao(lat_cen,dlon_utm)*0.9996])
                        if dif<1:
                ...
                if pr=='UTM':
                        ...
                        lon_mc=round(sh.iloc[0].geometry.centroid.x)
                        dlon=np.deg2rad(lon_mc)-lon_cen
